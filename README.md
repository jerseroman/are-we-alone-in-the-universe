...
<p align="center">
  <img src="assets/images/Banner.jpg" alt="Are We Alone in the Universe? Earth-like Planet Calculator banner" width="100%">
</p>
...
The v2.17 release is summarized in `RELEASE_NOTES_v2.17.md`.
...
For exact reproducibility, use the citation metadata in `CITATION.cff` together with the release tag or commit used for publication. The README badge uses the Zenodo concept DOI `10.5281/zenodo.20474527`, which represents all versions of this project.
