...
\providecommand{\dodoi}[1]{doi:~\href{https://doi.org/#1}{\nolinkurl{#1}}}
...
\hypersetup{
  ...
  pdfauthor={Roman Jerše},
  pdfsubject={Posterior model projection of narrow-domain ExoEarth candidates around old G dwarfs},
  pdfkeywords={Exoplanet occurrence; Kepler DR25; Milky Way disk; habitable zone; Bayesian inference}
}
...
Version~3 of this analysis already propagated separately reconstructed,
branch-specific correlated occurrence ensembles through the frozen Galactic
estimator; its principal calculation was not limited to fixed median vectors.
The present work reruns that reconstruction with corrected two-sided
measurement-error propagation, adaptive convergence gates, equalized
within-realization sampling, independent seed-family checks, and explicit
ESS/MCSE diagnostics. It also validates the host and TAMS selection, audits
direct DR25 support in the exact target, and freezes numerical, model, climate,
and spatial sensitivities before interpretation. The constant- and
zero-completeness treatments remain separate scenarios and are never pooled
into a confidence interval.
...
\citet{Kopparapu2013,Kopparapu2013Erratum,Kopparapu2014}. The modifier ``narrow-domain'' is
