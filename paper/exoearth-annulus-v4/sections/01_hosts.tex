...
does not replace the posterior summaries in Section~\ref{sec:results}. The
change in slope just outside 6 kpc is inherited from the pinned thin-disk SJ22
age--metallicity prescription, whose custom JJ parameterization changes branch
at $R_{\rm br,1}=6.0$ kpc; the thick-disk component remains smooth there. This
feature lies outside the adopted annulus and has not been smoothed.}
\label{fig:radial}
\end{figure*}
