...
reported statistical functional differ. The v4 median per-star occurrence,
1.23\% under constant completeness and 1.74\% under zero completeness, is
numerically below broad-HZ estimates as expected for its much narrower
integrated phase space.

\citet{Bryson2021} use $0.5$--$1.5\,\Rearth$, a complete conservative HZ, and
4800--6300 K stars for their quoted $\eta_\oplus$ values. Their 0.37 and 0.60
broad-HZ results are the source-model anchors for this analysis, not independent
corroboration. \citet{Kunimoto2020} report an 84.1\% upper limit below 0.18
