...
\citet{Jerse2026ExoEarthSoftware}, \emph{ExoEarth Annulus v4 Software},
version 4.0.2, Zenodo, doi:\href{https://doi.org/10.5281/zenodo.22070762}
{10.5281/zenodo.22070762}. The corresponding source release is available from
the public GitHub repository
\url{https://github.com/jerseroman/exoearth-annulus-v4-software} under tag
\texttt{v4.0.2}. Exact reproduction uses that version-specific archive and its
checksum manifest; the version-independent concept DOI is not used to identify
the software release underlying this manuscript.
...
32527877921. Run 32472776218 was a superseded partially failed production
attempt: its independently successful 400-realization constant-branch
aggregate is retained, while its failed 20,000-step zero-branch aggregate is
excluded. That failure triggered the unchanged-criteria full zero-branch rerun
32506666772 with a 30,000-step ceiling; all 400 rerun realizations passed. Run
32527877921 propagated the retained constant branch. The release evidence
contains the frozen numerical, host/TAMS, DR25-support, sensitivity, and
primary-literature records together with SHA-256 manifests.
