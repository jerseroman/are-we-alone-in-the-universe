...
population. The absence of direct local DR25 support and the excluded
metallicity-TAMS test are categorical findings, not plotted numerical error
bars.}
...
direct-local-support criterion is not met; this is not a software failure.
These distinctions prevent engineering reproducibility from being mislabeled
as observational validation.
