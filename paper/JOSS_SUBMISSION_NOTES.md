...
- Ensure `README.md`, `package.json`, `CITATION.cff`, `.zenodo.json`, release notes, and GitHub release metadata all agree on v2.17 and the current DOI.
...
- Confirm that the v2.17 release is tagged and archived on Zenodo, or be prepared to update the archive DOI during review.
